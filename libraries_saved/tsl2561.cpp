/*
	...
	Jaafar BenAbdallah, July 2015 / January 2017
	contributions:
	...
	3- added Adafruit's integer based illuminance value (lux) calculation
	4- adopted Adafruit begin(void) function to check device is connected using returned  ID

	Based on Arduino's libraries developed by SparkFun and Adafruit:
...
#include "tsl2561.h"
#include "math.h" //needed to use pow(x,a)
